...
static
APR_OPTIONAL_FN_TYPE (ap_cgi_build_command) *
  cgi_build_command;
...
static void
initialize_child (apr_pool_t * pchild, server_rec * main_server)
{
  apr_status_t rv;
...
static const command_rec fcgid_cmds[] = {
  ...
  AP_INIT_TAKE1 ("DefaultMaxClassProcessCount", set_default_max_class_process,
		 NULL, RSRC_CONF,
