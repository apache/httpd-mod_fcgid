...
static int fcgid_init(apr_pool_t* config_pool, apr_pool_t* plog, apr_pool_t* ptemp, 
...
{ 
	...
	if( (rv=proctable_post_config(main_server, config_pool))!=APR_SUCCESS )
	{
		ap_log_error(APLOG_MARK, APLOG_EMERG, rv, main_server,
	...
	if( (rv=procmgr_post_config(main_server, config_pool))!=APR_SUCCESS )
	{
		ap_log_error(APLOG_MARK, APLOG_EMERG, rv, main_server,
					"mod_fcgid: Can't initialize process manager");
		return rv;
...
static const command_rec fcgid_cmds[] = 
{
	...
	AP_INIT_TAKE1("IdleScanInterval", set_idle_scan_interval, NULL, RSRC_CONF,
	...
	AP_INIT_TAKE1("BusyScanInterval", set_busy_scan_interval, NULL, RSRC_CONF,
					"scan interval for busy timeout process"),
	AP_INIT_TAKE1("ErrorScanInterval", set_error_scan_interval, NULL, RSRC_CONF,
					"scan interval for exited process"),
	AP_INIT_TAKE1("ZombieScanInterval", set_zombie_scan_interval, NULL, RSRC_CONF,
	...
	AP_INIT_TAKE1("SpawnScoreUpLimit", set_spawnscore_uplimit, NULL, RSRC_CONF,
					"Spawn score up limit"),
	AP_INIT_TAKE1("SpawnScore", set_spawn_score, NULL, RSRC_CONF,
					"Score of spawn"),
	AP_INIT_TAKE1("TerminationScore", set_termination_score, NULL, RSRC_CONF,
					"Score of termination"),
	AP_INIT_TAKE1("MaxProcessCount", set_max_process, NULL, RSRC_CONF,
					"Max total process count"),
	AP_INIT_TAKE1("DefaultMaxClassProcessCount", set_default_max_class_process, NULL, RSRC_CONF,
					"Max process count of one class of fastcgi application"),
	AP_INIT_TAKE1("IPCConnectTimeout", set_ipc_connect_timeout, NULL, RSRC_CONF,
