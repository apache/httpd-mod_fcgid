...
fcgid_procnode *
proctable_get_table_array ()
{
  return g_proc_array;
}

fcgid_procnode *
proctable_get_error_list ()
{
...
size_t
proctable_get_table_size ()
{
  return g_table_size;
}

void
safe_lock (server_rec * main_server)
{
  apr_status_t rv;
...
void
safe_unlock (server_rec * main_server)
{
  /* Lock error is a fatal error */
  apr_status_t rv;
...
void
proctable_print_debug_info (server_rec * main_server)
{
  int freecount = 0;
